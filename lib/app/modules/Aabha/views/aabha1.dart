            ...
            children: [
              ...
              Container(
                  ...
                  child: Text("Create Your ABHA (Health ID)",
                      style: TextStyle(
                          fontSize: w / 100 * 4, fontWeight: FontWeight.w600))),
              Container(
                    ...
                    Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(w / 100 * 2)),
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          width: w,
                          padding: EdgeInsets.symmetric(vertical: h / 100 * 1),
                          decoration: BoxDecoration(
                              color: Color(0xFFF4F4F4),
                              borderRadius: BorderRadius.only(
                                  bottomLeft: Radius.circular(w / 100 * 3),
                                  bottomRight: Radius.circular(w / 100 * 3))),
                          child: Row(children: [
                            Container(
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                      color: kcWhite,
                      border: Border(top: BorderSide(color: kcGray, width: 1))),
                  width: w,
                  child: Column(
                    children: [
                      Container(
                              ...
                              children: [
                                      ...
                                      children: [
                                        Container(
                                            ...
                                            child: Image.asset(
                                                ...
                                                height: h / 100 * 4,
                                                fit: BoxFit.fill)),
                                        Text("Store Medical records digitally",
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                fontSize: w / 100 * 3))
                                      ]),
                                ...
                                SizedBox(
                                  ...
                                  child: Column(children: [
                                    Container(
                                        padding: EdgeInsets.all(w / 100 * 4),
                                        decoration: BoxDecoration(
                                            color: Color(0xFFD7D7FF),
                                            shape: BoxShape.circle),
                                        child: Image.asset(
