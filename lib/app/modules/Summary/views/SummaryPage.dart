                        ...
                        child: Obx(() => controller.summaryData.id == null
                            ? SingleChildScrollView(
                                ...
                                child: Column(
                                  children: [
                                    NoDataWidget(
                                      message: "To create summary, you need to upload documents first",
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Get.toNamed('/blogsHealthTips', parameters: {"healthTip_id": "9"});
                                      },
                                      child: Container(
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.all(Radius.circular(5)),
                                        ...
                                        height: screen.height * 0.05,
                                        child: Text(
                                          "How my summary looks like".toUpperCase(),
                            ...
                            : controller.summaryData.summaryDetail == null && controller.summaryData.id != null
                                ? Center(
                                    child: Column(
                                      children: [
                                        NoDataWidget(
                                          ...
                                          message: "Your summary is under creation",
                                        ),
                                        Spacer(),
                                        Container(
                                          padding: EdgeInsets.symmetric(horizontal: 13, vertical: 3),
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'DQ Care Support',
                                                      style: TextStyl.bodySm?.copyWith(
                                                          fontSize: 16, color: kcWhite, fontWeight: FontWeight.w600),
                                                    ),
                                                    Text(
                                                      'Sent you a message',
                                                      style: TextStyl.bodySm?.copyWith(
                                                          fontSize: 11, color: kcWhite, fontWeight: FontWeight.w600),
                                                    ),
                                                  ],
                                                )
                                              ],
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(horizontal: spacer4, vertical: spacer4),
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                children: [
                                                  CircleAvatar(
                                                    backgroundImage:
                                                        NetworkImage("${controller.summaryData.user?.avatar}"),
                                                    radius: 25,
                                                  ),
                                                  SizedBox(
                                                    height: spacer2,
                                                  ...
                                                  Row(
                                                    children: [
                                                      if (controller.summaryData.age != null)
                                                        Text(
                                                      ...
                                                      if (controller.summaryData.user?.gender != null)
                                                        Text(
                                            ...
                                            Center(
                                              ...
                                              Container(
                                                  ...
                                                  child: Table(
                                                      defaultColumnWidth: FixedColumnWidth(screen.width * 0.92),
                                                        ...
                                                        TableRow(children: [
                                                          ListView.builder(
                                                              ...
                                                              itemCount: controller
                                                                  .summaryData!.summaryDetail!.known_cases.length,
                                                              itemBuilder: (context, i) {
                                                                final item = controller
                                                                    .summaryData!.summaryDetail!.known_cases[i];
                                                                return Padding(
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.family_history.length,
                                                          itemBuilder: (context, i) {
                                                            final item = controller
                                                                .summaryData!.summaryDetail!.family_history[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.operative_history.length,
                                                          itemBuilder: (context, i) {
                                                            final item = controller
                                                                .summaryData!.summaryDetail!.operative_history[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.habit_history.length,
                                                          itemBuilder: (context, i) {
                                                            final item = controller
                                                                .summaryData!.summaryDetail!.habit_history![i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount:
                                                              controller.summaryData!.summaryDetail!.any_allergy.length,
                                                          itemBuilder: (context, i) {
                                                            final item =
                                                                controller.summaryData!.summaryDetail!.any_allergy![i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.current_medication!.length,
                                                          itemBuilder: (context, i) {
                                                            final item = controller
                                                                .summaryData!.summaryDetail!.current_medication[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.vaccination_history!.length,
                                                          itemBuilder: (context, i) {
                                                            final item = controller
                                                                .summaryData!.summaryDetail!.vaccination_history[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount:
                                                              controller.summaryData!.summaryDetail!.opd_visit.length,
                                                          itemBuilder: (context, i) {
                                                            final item =
                                                                controller.summaryData!.summaryDetail!.opd_visit[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                  ...
                                                  children: [
                                                    ...
                                                    TableRow(children: [
                                                      ListView.builder(
                                                          ...
                                                          physics: NeverScrollableScrollPhysics(),
                                                          itemCount: controller
                                                              .summaryData!.summaryDetail!.last_admitted!.length,
                                                          itemBuilder: (context, i) {
                                                            final item =
                                                                controller.summaryData!.summaryDetail!.last_admitted[i];
                                                            return Padding(
                                                                padding: const EdgeInsets.only(right: 4),
                                                                child: ListView.builder(
                                                                    shrinkWrap: true,
                                                      ...
                                                      children: [
                                                        ...
                                                        TableRow(children: [
                                                          ListView.builder(
                                                              ...
                                                              physics: NeverScrollableScrollPhysics(),
                                                              itemCount: controller
                                                                  .summaryData!.summaryDetail!.bloodGroup.length,
                                                              itemBuilder: (context, i) {
                                                                final item = controller
                                                                    .summaryData!.summaryDetail!.bloodGroup![i];
                                                                return Padding(
                                                                    padding: const EdgeInsets.only(right: 4),
                                                                    child: ListView.builder(
                                                                        shrinkWrap: true,
